...
public class PtrClassicDefaultHeaderEx extends FrameLayout implements PtrUIHandlerEx {
    ...
    public PtrClassicDefaultHeaderEx(Context context) {
        super(context);
        initViews(null);
    }

    public PtrClassicDefaultHeaderEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrClassicDefaultHeaderEx(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayoutEx frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
    ...
    private void crossRotateLineFromBottomUnderTouch(PtrFrameLayoutEx frame) {
        mTitleTextView.setVisibility(VISIBLE);
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.cube_ptr_pull_down_to_refresh));
        } else {
