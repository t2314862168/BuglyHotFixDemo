...
public class DataStatisticsByBusinessFragmentController extends BaseControllerWithActivity {
    public DataStatisticsByBusinessFragmentController(BaseActivity baseActivity) {
        super(baseActivity);
    }
