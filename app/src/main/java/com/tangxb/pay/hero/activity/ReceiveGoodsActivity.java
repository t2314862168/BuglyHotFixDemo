...
public class ReceiveGoodsActivity extends BaseActivityWithSearch {
    ...
    protected void initData() {
        ...
        CommonAdapter commonAdapter = new CommonAdapter<DeliverPersonBean>(mActivity, R.layout.item_receive_goods, dataList) {
            @Override
...
//                viewHolder.setText(R.id.tv_car_number, item.getName());
//                viewHolder.setText(R.id.tv_date, item.getName());
//                viewHolder.setText(R.id.tv_send_goods_man, item.getName());
//                viewHolder.setText(R.id.tv_receive_goods_man, item.getName());
